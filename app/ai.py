...
В поле "body" НЕ добавляй хештеги (#слово) ни в конце, ни где-либо ещё в тексте —
человек расставляет теги сам отдельно. Это касается и самого текста поста, и того,
чтобы не дублировать список хештегов дважды.
...
- "tags": релевантные теги через запятую (без символа #) — отдельно от текста поста
