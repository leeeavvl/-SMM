...
- ЗАПРЕЩЕНО выдумывать конкретных людей, клиентов, резидентов сообщества или кейсы
  ...
  вправе считать это правдой о конкретном человеке). Если нужен пример для иллюстрации —
  либо используй общую формулировку без имени («один из резидентов сообщества...», без
  придуманных деталей биографии), либо явно обозначь гипотетичность («представим
  ситуацию:», «типичный пример:») — но не выдавай вымысел за случившуюся историю.
